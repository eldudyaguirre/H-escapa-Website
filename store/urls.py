...
urlpatterns = [
    ...
    path("homein-pacientes/perfil/<int:paciente_id>/", views.homeinperfilpaciente, name="homeinperfilpaciente"),
    path("homein-pacientes/editar/<int:paciente_id>/", views.homeineditarpaciente, name="homeineditarpaciente"),
